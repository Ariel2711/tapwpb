...
<div class="card card-outline card-secondary">
    <div class="card-header">
        <h5 class="card-title">Daftar Konten </h5>
        <div class="card-tools">
            <button type="button" class="btn btn-tool" data-card-widget="collapse">
                <i class="fas fa-minus"></i>
            </button>
            <a href="<?= base_url('post/create'); ?>" class="btn btn-secondary btn-xs"><i class="fa fa-plus"></i> Upload Konten</a>
        </div>
    </div>
                    ...
                    <tr>
                        ...
                        <td width="100" class="text-right">
                            <div class="btn-group">
                                ...
                                <a href="<?= base_url('post/delete/') . $row->post_id; ?>" onclick="return confirm('Yakin ingin menghapus?');" class="btn btn-default btn-sm"><i class="fa fa-trash"></i></a>
                            </div>
                        </td>
                    </tr>
                <?php endforeach; ?>
