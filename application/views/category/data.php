    ...
    <div class="col-md-3 mb-4">
        ...
        <div class="card card-outline card-primary shadow-sm">
            <div class="card-header">
                <h3 class="card-title" id="form-title">Kategori Baru</h3>
            ...
            <div class="card-body">
                <div class="mb-3">
                    <label for="category_name" class="form-label required">Kategori</label>
                    <input value="<?= set_value('category_name'); ?>" type="text" name="category_name" id="category_name" class="form-control" placeholder="Nama Kategori...">
                    <?= form_error('category_name'); ?>
                </div>
                <!-- <div class="mb-3">
                    <label for="category_desc" class="form-label">Deskripsi</label>
                    <textarea name="category_desc" id="category_desc" rows="3" class="form-control" placeholder="Deskripsi Kategori..."><?= set_value('category_desc'); ?></textarea>
                    <?= form_error('category_desc'); ?>
                </div> -->
            </div>
            <div class="card-footer text-right">
                <button type="reset" id="btn-cancel" class="btn btn-secondary">Cancel</button>
