<!-- <?php if (userdata()) : ?>
    ...
    <div class="card mb-3">
        <div class="">
            ...
            <textarea class="form-control" rows="4" name="comment_body" placeholder="Tulis disini"></textarea>
...
<?php else : ?>
    <div class="alert alert-info text-center">
        Login terlebih dahulu jika ingin menulis komentar.
        <a href="<?= base_url('signin'); ?>" class="d-block small font-weight-bold">Login</a>
    </div>
<?php endif; ?>
                                ...
                                <?php if (userdata()) : ?>
                                    <div class="text-right mb-3">
                                        ...
                                        <?php if (userdata()->user_id == $c->user_id || userdata()->role == "admin") : ?>
                                            <a onclick="return confirm('Yakin ingin menghapus?')" href="<?= base_url('comment/delete/' . $c->comment_id); ?>" class="btn btn-default">
                                                Hapus
                                            </a>
                                        <?php endif; ?>
                                    </div>
